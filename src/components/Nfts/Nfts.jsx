        ...
        <section id={css.nfts}>
            ...
            <div className={css.content}>
                <div className={css.info}>
                    ...
                    <p>
                        No, not those NFTs(although they seem to be equally worthless nowadays)...
                    </p>
                ...
                <div className={css.info}>
                    ...
                    <p>
                        As mentioned above, this was an ongoing project from my first introduction to React, to the finishing exam of the course. As can be expected, there was a lot of moving forward and backwards around the project as new approaches and methodology of working with React were introduced. From Prop-drilling to using Context. From holding everything in one mega-component, to using separate Services and even custom Hooks. A lot of refactoring of code happened during that time.
